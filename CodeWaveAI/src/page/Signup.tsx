...
export function Signup() {
    ...
    return <div className="h-screen w-screen bg-n-8 flex justify-between px-[15%] items-center">
        ...
        <h1 className="text-2xl mb-10 font-bold text-gray-700">Sign Up</h1>
            ...
            <input className="p-2 ml-4 rounded-lg" ref={passwordRef} placeholder="Password" />
            <div className=" justify-center pt-6">
                <button className="p-2 mr-4 bg-gray-700 text-white rounded-lg" onClick={signup}>SignUp</button>
